...
const file_api_proto_user_user_proto_rawDesc = "" +
	...
	"\vUserService\x123\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x12.user.UserResponseB1Z/github.com/LizaMeytner/prgLo/api/proto/gen/userb\x06proto3"
...
var file_api_proto_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
